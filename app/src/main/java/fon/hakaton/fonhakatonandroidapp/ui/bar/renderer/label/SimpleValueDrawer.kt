package fon.hakaton.fonhakatonandroidapp.ui.bar.renderer.label
...
import fon.hakaton.fonhakatonandroidapp.common.toLegacyInt
import fon.hakaton.fonhakatonandroidapp.ui.bar.renderer.label.SimpleValueDrawer.DrawLocation.*

class SimpleValueDrawer(
    private val drawLocation: DrawLocation = XAxis,
